...
import SidebarNewHandovers from "./SidebarNewHandover";
...
const _Tables = ({
  ...
  const CustomPagination = () => {
    const count = Number(Math.ceil(totalHandover / rowsPerPage));
...
const mapStateToProps = ({
  ...
  return {
    listData: reducerHandover.listDataDataTable,
    totalHandover: reducerHandover.totalHandover,
